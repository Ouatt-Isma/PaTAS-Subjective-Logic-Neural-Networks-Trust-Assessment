...
# Gap 3, leakage 0.25. The attacker also compromises part of the audited
# source, so the provenance labels are partly wrong: 0.25 of the poison sits
...
python $REPO/eval_multisource.py --arch 128 --epochs 20 --seeds 0 1 \
    --unknown-classes 4 7 --poison-leak 0.25
