...
# Gap 1, seed 1. Provenance-guided pruning against what a defender with the
...
python $REPO/influence_baseline.py --dataset mnist --arch 128 --poisoned-patch 4 --seeds 1
